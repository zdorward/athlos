...
Athlos is an adaptive training system for hybrid athletes (running + lifting). The goal is to build a platform that intelligently adjusts training programs based on athlete performance, recovery, and goals.
